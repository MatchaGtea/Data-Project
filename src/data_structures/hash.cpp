...
void hashDelete(HashTable* ht, const char* name) {
    // TODO (Member 3): Delete entry and re-probe to fix chain
    // Note: simple deletion breaks linear probing — need to re-insert affected entries
    std::cout << "TODO: hashDelete\n";
}
